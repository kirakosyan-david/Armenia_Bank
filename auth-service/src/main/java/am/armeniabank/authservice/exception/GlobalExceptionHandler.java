package am.armeniabank.authservice.exception;

import am.armeniabank.authservice.dto.RestErrorDto;
import am.armeniabank.authservice.exception.custom.ChangePasswordException;
import am.armeniabank.authservice.exception.custom.DeleteNotFoundException;
import am.armeniabank.authservice.exception.custom.SendMessageException;
