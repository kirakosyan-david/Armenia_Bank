...
public class KafkaTopicConfig {
    ...
    @Bean
    public NewTopic walletEventsTopic(@Value("${spring.kafka.topic.transaction-events}") String topic) {
    ...
    public boolean checkTopicsExist(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers,
                                    @Value("${spring.kafka.topic.transaction-events}") String walletTopic,
